...
from CaptionsDatasetOrigin import collate
from torch.utils.data import DataLoader
from CaptionsDatasetOrigin import CaptionsDataset
...
def train(
    ...
    for epoch in range(epochs):
        ...
        for idx, (captions_clip, captions_gpt_tokens, captions_tokens_for_loss, masks, hard_prompts_length, rt_feat) in enumerate(dataloader):
            ...
            # captions_tokens_for_loss[0]captions_tokens_for_loss[0]
...
def main():
    ...
    parser.add_argument('--language_model', default = '/home/cumt/workspace/IFCap/DiffuLLaMA-main/gpt2', help = 'gpt2, facebook/opt-350m')
    ...
    parser.add_argument('--path_of_datasets', default = f'/home/cumt/workspace/IFCap/annotations/coco/coco_texts_features_ViT-B32.pickle') # coco_with_entities
    ...
    # model.load_state_dict(torch.load("/home/cumt/workspace/IFCap/checkpoints/train_flickr30k/flickr-indomain-0014.pt", map_location = args.device), strict=False)
