...
if __name__ == '__main__':
    ...
    idx = 5 # change here! 0 -> coco training data, 1 -> flickr30k training data
    device = 'cuda:0'
    clip_type = 'ViT-B/32' # change here for different clip backbone (ViT-B/32, RN50x4)
    clip_name = clip_type.replace('/', '')
    ...
    './annotations/flickr30k/flickr30k_with_entities.pickle',
    "/home/cumt/workspace/IFCap/annotations/msvd/msvd_with_entities.pickle",
    "/home/cumt/workspace/IFCap/annotations/msrvtt/msrvtt_with_entities.pickle",
    ...
    f'./annotations/flickr30k/flickr30k_texts_features_{clip_name}.pickle',
    f'./annotations/msvd/msvd_texts_features_{clip_name}.pickle',
    f'./annotations/msrvtt/msrvtt_texts_features_{clip_name}.pickle',
