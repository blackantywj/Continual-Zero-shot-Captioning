...
def get_image_path(domain):
    datasets = {
            ...
            'sydney': "/home/cumt/workspace/IFCap/Sydney-captions/images",
            'ucm': "/home/cumt/workspace/IFCap/UCM_captions/imgs",
            }
    return datasets[domain]
...
def main():
    ...
    parser.add_argument('--domain_test', default = 'sydney', help = 'Name of test dataset', choices=['coco', 'flickr30k', 'nocaps'])
    parser.add_argument('--domain_source', default = 'sydney', help = 'Name of source dataset', choices=['coco', 'flickr30k'])
