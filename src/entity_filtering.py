...
if __name__ == '__main__':
    ...
    IDX = 6
    inputs = [
            "coco_train_task_woclass_0_1000.json",
            "caption_flickr30k_image_flickr30k_7.json",
            "caption_coco_image_nocaps_7.json",
            "caption_msvd_image_msvd_5_woclass.json",
            "caption_msrvtt_image_msrvtt_5_woclass.json",
            "caption_sydney_image_sydney_9.json",
            "caption_ucm_image_ucm_9.json",
            ]
