...
def main():
    ...
    for i in range(5):
        if not args.multitask:
            args.path_of_datasets = f"annotations/coco/coco_/coco_with_entities_cocoid_imgfeature_task0-{args.tasknum}.pickle"
            args.rt_path = f"annotations/coco/coco_/coco_train_task0-{args.tasknum}.json"      
        else:    
            args.path_of_datasets = f"annotations/coco/coco_/coco_with_entities_cocoid_imgfeature_task0+{args.tasknum}.pickle"
            args.rt_path = f"annotations/coco/coco_/coco_train_task0+{args.tasknum}.json"        
