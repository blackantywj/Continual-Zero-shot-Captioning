...
from ClipCapMemory import ClipCaptionModel, ClipCaptionPrefix
...
def main():
    ...
    parser.add_argument('--path_of_datasets', default = f'annotations/coco/coco_with_entities_cocoid_imgfeature.pickle') # coco_with_entities
    parser.add_argument('--out_dir', default = './checkpoints', help = 'the path of output')
    parser.add_argument('--normalize_prefix', dest = 'normalize_prefix', type = int, default = 1, help = 'normalizing prefix')
    ...
    parser.add_argument('--rt_path', default='./annotations/coco/coco_train_woclass_img_cap.pickle')
    parser.add_argument('--use_moe_lora', type=bool, default=False)
    parser.add_argument('--tasknum', type=int, default=3)
    ...
    # for i in range(args.subtask):

    if not args.multitask:
        args.path_of_datasets = f"annotations/coco/coco_with_entities_cocoid_imgfeature_woclass_{args.tasknum}.pickle"
        args.rt_path = f"annotations/coco/coco_train_task_woclass_{args.tasknum}.json"        
    else:    
        args.path_of_datasets = f"annotations/coco/coco_with_entities_cocoid_imgfeature_woclass_0-{args.tasknum}.pickle"
        args.rt_path = f"annotations/coco/coco_train_task_woclass_0-{args.tasknum}.json"
