...
def main(args) -> None:
    ...
    modelnew1.load_state_dict(torch.load("/home/liu/.workspace/IFCap/checkpoints_r32_alpha64_0_1/train_msvd/002.pt"), strict=False)
    modelnew1.to(device)
    ...
    modelold.load_state_dict(torch.load("/home/liu/.workspace/IFCap/checkpoints_r32_alpha64_0_0/train_flickr30k/009.pt"), strict=False)
    modelold.to(device)
