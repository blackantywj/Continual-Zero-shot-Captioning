...
if __name__ == '__main__':
    datasets = ['coco_captions', 'flickr30k_captions', "msvd_captions", "msrvtt_captions", "sydney_captions", "ucm_captions"]
    captions_path = [
        './annotations/coco/test_captions.json',
        # './annotations/flickr30k/train_captions.json',
        './annotations/flickr30k/val_captions.json',
        "/home/cumt/workspace/IFCap/annotations/msvd/test_captions.json",
        "/home/cumt/workspace/IFCap/annotations/msrvtt/validation_dataset.json",
        "/home/cumt/workspace/IFCap/annotations/sydney/train_captions.json",
        "/home/cumt/workspace/IFCap/annotations/ucm/train_captions.json"
    ]
    out_path = [
        './annotations/coco/coco_with_entities_test.pickle',
        # './annotations/flickr30k/flickr30k_with_entities.pickle',
        './annotations/flickr30k/flickr30k_with_entities_val.pickle',
        "/home/cumt/workspace/IFCap/annotations/msvd/test_msvd_with_entities.pickle",
        "/home/cumt/workspace/IFCap/annotations/msrvtt/validation_msrvtt_with_entities.pickle",
