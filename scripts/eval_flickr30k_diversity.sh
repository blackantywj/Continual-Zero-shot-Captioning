...
$CPU_SET python src/validation_diversity.py \
--device cuda:$DEVICE \
--clip_model ViT-B/32 \
--language_model gpt2 \
...
echo "==========================FLICKR EVAL================================"
python /home/cumt/workspace/IFCap/evaluation/cocoeval.py --result_file_path $FLICKR_OUT_PATH/flickr30k*.json |& tee -a  ${FLICKR_LOG_FILE}
