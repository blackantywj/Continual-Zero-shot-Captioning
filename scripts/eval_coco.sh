...
WEIGHT_PATH=checkpoints_img_fea_best_1098_norm_prefix_0/$EXP_NAME/"${CKPT_NAME}-00${ckpt_num}.pt"
...
--image_folder /usr/data/data/coco/val2014/ \
--prompt_ensemble \
...
echo "==========================COCO EVAL================================"
python /home/cumt/workspace/IFCap/evaluation/cocoeval_new.py --result_file_path $COCO_OUT_PATH/coco*.json |& tee -a  ${COCO_LOG_FILE}